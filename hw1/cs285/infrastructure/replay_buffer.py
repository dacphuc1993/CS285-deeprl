...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        ## DONE
        index = np.random.permutation(len(self.obs))

        return (self.obs[index[-batch_size]], 
                self.acs[index[-batch_size:]], 
                self.rews[index[-batch_size:]], 
                self.next_obs[index[-batch_size:]], 
                self.terminals[index[-batch_size:]])
